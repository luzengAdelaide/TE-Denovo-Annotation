...
public class GenerateAnnotatedLibrary {
	...
	private static String iDir = "/data/rc003/lu/opossum/consensus94/results_classify/";
	private static String oDir = "library/";
	private static String library = oDir + "Opossum94_Library.fasta";
	...
	private static String CSFile = iDir + "mdo94_250bp.ConsensusSequences.fa";
	...
	private static String IRS = iDir + "mdo94_250bp.ConsensusSequences.fa.map"; 
