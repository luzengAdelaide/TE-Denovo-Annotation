...
perl fastq2fasta.pl -a file (output a file with fa) - converts fastq files to fasta format.
...
Usage: perl script.pl options
 required:
  -afastq input file.
 optional:
  -cinset in nucleotides, used to remove barcodes [default = 0].
  -vverbose mode [T/F, default is F].
